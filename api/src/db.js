...
modelDefiners.forEach(model => model(sequelize));     //cada modelo recibe una instancia de sequelize
...
module.exports = {
  ...sequelize.models, // importar los modelos así: const { Product, User } = require('./db.js');
